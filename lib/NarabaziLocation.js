...
NarabaziLocation = (function(controller) {
  ...
  */
  function createLocation(latlng, options) {
    if(latlng==undefined) {
  ...
  */
  ...
  controller.core("saveNewLocation").subscribe(saveNewLocation);
  controller.core("deleteLocation").subscribe(deleteLocation);
  controller.core("undrawLocation").subscribe(undrawLocation);
  controller.core("drawLocation").subscribe(drawLocation);
  controller.core("createMarker").subscribe(createLocation);
