...
var Narabazi =
{
  url : // declare our endpoints
  {
    ...
    // our geo json data
    locations   : 'http://192.168.1.142/discontented/web/app_dev.php/json',
    // where to send our new nodes to save them
    locationAdd : 'http://192.168.1.142/discontented/web/app_dev.php/add',
  },
     ...
     Narabazi.markerLayer = L.geoJson(Narabazi.getGeoJsonShell(), {
       ...
       onEachFeature: function (feature, layer) {
         ...
         layer.on('click', function() { 
           Narabazi.message('Marker clicked', 1);
           Narabazi.displayLink();
         })
       }
     }).addTo(this.getMap());
  },
  ...
  */
  ...
  {
    Narabazi.message('Location clicked: ' + link, 1);
