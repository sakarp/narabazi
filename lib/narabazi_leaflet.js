...
var Narabazi =
{
  ...
  init: function()
  {
    ...
    $.getScript("lib/NarabaziLink.js", function(data, textStatus, jqxhr) {
      Narabazi.message('Narabazi data types loading: ' + textStatus, 2);
    });    
  ...
  */
  deleteNode: function(marker)
  {
    ...
    ({
      ...
      //  , data: { [ name: 'foo', value: 'bar' ], [ name: 'baz', value: 100 ] }
      // this is called after the saving is completed:
      success: function(resp){ Narabazi.message('Removed node: '+resp, 1); }
    });
  },
      ...
      success: function(data){
        ...
        $.link.linkTemplate("#link_list", data)
          ...
          .on("click", "#button_link_add", function() {
            ...
            $.link.addLinkTemplate( "#link_add", NarabaziLink.linkDetails, NarabaziLink );
            ...
            $("#submitAddLink").on( "click", function() {
              ...
              ({
                ...
                method: 'post',
                // send the click events data
                data: { type: NarabaziLink.linkDetails.selectedType, 
                         title: NarabaziLink.linkDetails.title, 
                         link: NarabaziLink.linkDetails.link, q: true },
                success: function (response)
                { 
...
//        $('#button_link_delete').data('id',)
  ...
  /**
  * DEPRECIATED: Get a link to remove a marker from the map
  *
